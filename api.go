...
// QueryWxUserOption 查询参数方法
type QueryWxUserOption func(q url.Values)

func WithQueryAppToken(token string) QueryWxUserOption {
	return func(q url.Values) {
		q.Add("appToken", token)
	}
}

func WithQueryPage(page int) QueryWxUserOption {
	return func(q url.Values) {
		q.Add("page", strconv.Itoa(page))
	}
}

func WithQueryPageSize(pageSize int) QueryWxUserOption {
	return func(q url.Values) {
		q.Add("pageSize", strconv.Itoa(pageSize))
	}
}

func WithQueryUid(uid string) QueryWxUserOption {
	return func(q url.Values) {
		q.Add("uid", uid)
	}
}
...
func QueryWxUser(opts ...QueryWxUserOption) (model.QueryWxUserResult, error) {
